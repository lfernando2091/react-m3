...
export const ButtonSection = () => {
  return (<Stack spacing={3}>
    ...
    <Stack direction='row' spacing={2} flexWrap={'wrap'}>
      <Button endIcon={<NotificationsActiveIcon />} variant="elevated" >Elevated</Button>
      <Button endIcon={<NotificationsActiveIcon />} variant="filled">Filled</Button>
      <Button endIcon={<NotificationsActiveIcon />} variant="tonal">Tonal</Button>
      <Button endIcon={<NotificationsActiveIcon />} variant="outlined">Outlined</Button>
      <Button endIcon={<NotificationsActiveIcon />} variant="text">Text</Button>
    </Stack>
    <Stack direction='row' spacing={2} flexWrap={'wrap'} >
